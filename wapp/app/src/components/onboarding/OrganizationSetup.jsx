    ...
    <div className="p-6 space-y-6">
      <div className="text-center mb-6">
        ...
        <p className="text-lg text-gray-600 max-w-2xl mx-auto">
          {hasOrganizations
            ? "You already have an organization. You can continue or create another one."
      ...
      {createSuccess ? (
        ...
        <div className="max-w-xl mx-auto">
          ...
          <div className="text-center">
            <p className="text-sm text-gray-500 mb-2">or create a new organization</p>
          </div>
        </div>
      ) : null}
          ...
          <div className="flex justify-between mt-8">
            ...
            >
              {isLoading ? (
                ...
                <>
                  {hasOrganizations ? 'Create New Organization' : 'Create Organization'}
                  <ArrowRight className="ml-2 h-5 w-5" />
                </>
              )}
            </button>
