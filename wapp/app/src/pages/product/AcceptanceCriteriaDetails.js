...
import { Loader, AlertCircle, ArrowLeft, TestTube, Plus, CheckCircle, XCircle } from 'lucide-react';
...
const AcceptanceCriteriaDetails = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-6">
            ...
            {criteria && (
              <div className="bg-white rounded-lg shadow-md p-6 mb-6">
                <div className="flex items-center mb-4">
                  ...
                  <h1 className="text-3xl font-bold text-gray-800">{criteria.title}</h1>
                </div>
                ...
                <div className="space-y-4">
                  {criteria.tests.map((test, index) => (
                    ...
                    >
                      ...
                      {test.code && (
                        <div className="mt-4">
                          <div className="text-sm font-medium text-gray-700 mb-2">Test Code:</div>
                          <pre className="p-4 bg-gray-50 rounded-lg overflow-x-auto">
                            <code className="text-sm">{test.code}</code>
                          </pre>
                        </div>
                      )}
                    </div>
      ...
      {/* Add Test Modal */}
      {isAddTestModalOpen && criteria && (
        <AddTestModal
          onClose={() => {
            console.log("onClose called in AcceptanceCriteriaDetails");
            setIsAddTestModalOpen(false);
          }}
