...
@overload
def get_string(name: str, default: str | None = None, required: Literal[True] = True) -> str: ...

@overload
def get_string(name: str, default: str | None = None, required: Literal[False] = False) -> str | None: ...

def get_string(name: str, default: str | None = None, required: bool = True) -> str | None:
  """
...
@overload
def get_bool(name: str, default: bool | None = None, required: Literal[True] = True) -> bool: ...

@overload
def get_bool(name: str, default: bool | None = None, required: Literal[False] = False) -> bool | None: ...

def get_bool(name: str, default: bool | None = None, required: bool = True) -> bool | None:
  """
  ...
  raise Exception(f"Invalid value for {name}: Must be either 'true' or 'false', not {value}")