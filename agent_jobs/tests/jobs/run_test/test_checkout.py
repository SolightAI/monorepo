...
class TestTickPick:
    url = "https://tickpick_dev:tickpick.1@dev.tickpick.com/checkout?listingId=889809947&quantity=1&listingType=TEVO&price=96&dt=f&dv=2&e=7089570&s=123&r=14"
    ...
    async def _run_checkout_test(
        ...
        ), f"Expected {expected_status.value} but got {result['status']}"
