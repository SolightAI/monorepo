...
from src.common.dto import Test, TestCategory, TestStatus, Product
from src.jobs.improve_test_steps.handler import handler
...
class TestTickPick:
    ...
    async def test_checkout_detailed_steps(self, task_id: str, config: Config) -> None:
        ...
        ), f"Found assertion in the test steps: {new_test_steps.results}"
