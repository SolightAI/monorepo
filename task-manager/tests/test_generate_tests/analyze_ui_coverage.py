...
def analyze_ui_coverage(tests: List[Dict]) -> Dict:
    ...
    system_prompt = dedent("""\
        You are an expert UI test coverage analyzer. Your task is to analyze a set of test cases and extract information about UI coverage.
    ...
    human_prompt = dedent(f"""\
        Please analyze the following test cases and provide UI coverage analysis:
