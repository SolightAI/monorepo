...
class TestTickPick():
    ...
    @pytest.mark.asyncio
    async def test_initiate_checkout_for_selected_tickets_negative(self, task_id: str) -> None:
    ...
    @pytest.mark.asyncio
    async def test_preconditions_not_met_failed_to_start_test(self, task_id: str) -> None:
    ...
    @pytest.mark.asyncio
    async def test_valid_credit_card_succeed(self, task_id: str) -> None:
    ...
    @pytest.mark.asyncio
    async def test_valid_credit_card_succeed_but_agent_fails_bcs_of_result_msg(self, task_id: str) -> None:
