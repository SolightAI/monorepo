...
const faqs = [
  {
    question: "What is Solight?",
    answer: "Solight is an AI-powered video creation platform that transforms your ideas into captivating videos. Simply input your concept, and our advanced AI will generate a unique video based on your description."
  },
  {
    question: "How does Solight work?",
    answer: () => (
        <div>
          <p className="mb-4">
            Solight leverages a sophisticated blend of AI technologies to create videos from your text prompts. It utilizes:
          </p>
  ...
  {
    question: "What types of videos can I create with Solight?",
  ...
  },
  {
    ...
    answer: "Yes, you have full rights to use the videos generated by Solight, including for commercial purposes. However, please ensure you have the necessary rights for any specific content you request in your prompts."
  },
  {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-r from-blue-50 to-indigo-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-3xl mx-auto bg-white p-8 rounded-xl shadow-lg">
        <h1 className="text-4xl font-bold text-center mb-4 text-gray-900">Solight</h1>
