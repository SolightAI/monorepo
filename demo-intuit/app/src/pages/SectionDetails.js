    ...
    <div className="flex flex-col items-center justify-center min-h-screen p-4">
      <div className="w-full max-w-md bg-white rounded-lg shadow-lg p-8 relative">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">Specify which section to test</p>
          {savedUrl && (
          ...
          <div className="mt-2 p-2 bg-gray-100 rounded-md text-sm">
            <span className="font-medium">Test Type:</span> Specific Section
          </div>
        </div>

        <form onSubmit={handleSubmit}>
          <div className="mb-6">
            <label htmlFor="section-details" className="block text-sm font-medium text-gray-700 mb-2">
              Section Details:
            </label>
            <textarea
              id="section-details"
